...
@E2E @Regression @GrantsWorkflow @User_ABDULLAH
Feature: E2E Grant Workflow — User_ABDULLAH

  @Step1 @Citizen @User_ABDULLAH
  Scenario Outline: TC-E2E-01-ABDULLAH — Citizen <username> submits grant with <grantArea>
    ...
    Examples:
      | username   | grantArea            |
      | abdullah   | مساحة ٢٠٠ × ٢٠٠      |
      | abdullah   | مساحة ١٠٠ × ١٠٠      |
      | abdullah   | مساحة ٥٠ × ٥٠        |
      | abdullah   | مساحة ٤٠ × ٤٠        |
      | abdullah   | مساحة ٣٠ × ٣٠        |
      | abdullah   | مساحة ٢٥ × ٢٥        |
      | abdullah   | مساحة ٢٠ × ٢٠        |

  @Step2 @GrantEmployee @User_ABDULLAH
  Scenario Outline: TC-E2E-02-ABDULLAH — Grant Employee processes transaction <txIndex>
    Given I navigate to the portal login page
  ...
  @Step3 @GrantManager @User_ABDULLAH
  Scenario Outline: TC-E2E-03-ABDULLAH — Grant Manager finalizes transaction <txIndex>
    Given I navigate to the portal login page
