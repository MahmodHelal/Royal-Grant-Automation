...
@E2E @Regression @GrantsWorkflow @User_MALDOSSARY
Feature: E2E Grant Workflow — User_MALDOSSARY

  @Step1 @Citizen @User_MALDOSSARY
  Scenario Outline: TC-E2E-01-MALDOSSARY — Citizen <username> submits grant with <grantArea>
    ...
    Examples:
      | username   | grantArea            |
      | maldossary | مساحة ٢٠٠ × ٢٠٠      |
      | maldossary | مساحة ١٠٠ × ١٠٠      |
      | maldossary | مساحة ٥٠ × ٥٠        |
      | maldossary | مساحة ٤٠ × ٤٠        |
      | maldossary | مساحة ٣٠ × ٣٠        |
      | maldossary | مساحة ٢٥ × ٢٥        |
      | maldossary | مساحة ٢٠ × ٢٠        |

  @Step2 @GrantEmployee @User_MALDOSSARY
  Scenario Outline: TC-E2E-02-MALDOSSARY — Grant Employee processes transaction <txIndex>
    Given I navigate to the portal login page
  ...
  @Step3 @GrantManager @User_MALDOSSARY
  Scenario Outline: TC-E2E-03-MALDOSSARY — Grant Manager finalizes transaction <txIndex>
    Given I navigate to the portal login page
