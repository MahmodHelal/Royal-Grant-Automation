...
@E2E @Regression @GrantsWorkflow @User_MAMDOUH
Feature: E2E Grant Workflow — User_MAMDOUH

  @Step1 @Citizen @User_MAMDOUH
  Scenario Outline: TC-E2E-01-MAMDOUH — Citizen <username> submits grant with <grantArea>
    ...
    Examples:
      | username   | grantArea            |
      | mamdouh    | مساحة ٢٠٠ × ٢٠٠      |
      | mamdouh    | مساحة ١٠٠ × ١٠٠      |
      | mamdouh    | مساحة ٥٠ × ٥٠        |
      | mamdouh    | مساحة ٤٠ × ٤٠        |
      | mamdouh    | مساحة ٣٠ × ٣٠        |
      | mamdouh    | مساحة ٢٥ × ٢٥        |
  ...
  @Step2 @GrantEmployee @User_MAMDOUH
  Scenario Outline: TC-E2E-02-MAMDOUH — Grant Employee processes transaction <txIndex>
    Given I navigate to the portal login page
  ...
  @Step3 @GrantManager @User_MAMDOUH
  Scenario Outline: TC-E2E-03-MAMDOUH — Grant Manager finalizes transaction <txIndex>
    Given I navigate to the portal login page
