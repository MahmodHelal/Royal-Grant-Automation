...
@E2E @Regression @GrantsWorkflow @User_IBRAHEM
Feature: E2E Grant Workflow — User_IBRAHEM

  @Step1 @Citizen @User_IBRAHEM
  Scenario Outline: TC-E2E-01-IBRAHEM — Citizen <username> submits grant with <grantArea>
  ...
  @Step2 @GrantEmployee @User_IBRAHEM
  Scenario Outline: TC-E2E-02-IBRAHEM — Grant Employee processes transaction <txIndex>
    Given I navigate to the portal login page
  ...
  @Step3 @GrantManager @User_IBRAHEM
  Scenario Outline: TC-E2E-03-IBRAHEM — Grant Manager finalizes transaction <txIndex>
    Given I navigate to the portal login page
