...
@E2E @Regression @GrantsWorkflow @User_OWNERTEST
Feature: E2E Grant Workflow — User_OWNERTEST

  @Step1 @Citizen @User_OWNERTEST
  Scenario Outline: TC-E2E-01-OWNERTEST — Citizen <username> submits grant with <grantArea>
    ...
    Examples:
      | username   | grantArea            |
      | ownertest  | مساحة ٢٠٠ × ٢٠٠      |
      | ownertest  | مساحة ١٠٠ × ١٠٠      |
      | ownertest  | مساحة ٥٠ × ٥٠        |
      | ownertest  | مساحة ٤٠ × ٤٠        |
      | ownertest  | مساحة ٣٠ × ٣٠        |
      | ownertest  | مساحة ٢٥ × ٢٥        |
      | ownertest  | مساحة ٢٠ × ٢٠        |

  @Step2 @GrantEmployee @User_OWNERTEST
  Scenario Outline: TC-E2E-02-OWNERTEST — Grant Employee processes transaction <txIndex>
    Given I navigate to the portal login page
  ...
  @Step3 @GrantManager @User_OWNERTEST
  Scenario Outline: TC-E2E-03-OWNERTEST — Grant Manager finalizes transaction <txIndex>
    Given I navigate to the portal login page
