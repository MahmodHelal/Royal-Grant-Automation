...
@E2E @Regression @GrantsWorkflow @RandomDist
Feature: E2E Grant Workflow — RandomDist

  @Step1 @Citizen @RandomDist
  Scenario Outline: TC-E2E-01-RANDOM — Citizen <username> submits grant with <grantArea>
    ...
    Examples:
      ...
      | ibrahem    | مساحة ٢٠٠ × ٢٠٠      |
      | mamdouh    | مساحة ٢٥ × ٢٥        |

  @Step2 @GrantEmployee @RandomDist
  Scenario Outline: TC-E2E-02-RANDOM — Grant Employee processes transaction <txIndex>
    Given I navigate to the portal login page
  ...
  @Step3 @GrantManager @RandomDist
  Scenario Outline: TC-E2E-03-RANDOM — Grant Manager finalizes transaction <txIndex>
    Given I navigate to the portal login page
