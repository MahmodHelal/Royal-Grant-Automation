...
@E2E @Regression @GrantsWorkflow @User_EMAD
Feature: E2E Grant Workflow — User_EMAD

  @Step1 @Citizen @User_EMAD
  Scenario Outline: TC-E2E-01-EMAD — Citizen <username> submits grant with <grantArea>
  ...
  @Step2 @GrantEmployee @User_EMAD
  Scenario Outline: TC-E2E-02-EMAD — Grant Employee processes transaction <txIndex>
    Given I navigate to the portal login page
  ...
  @Step3 @GrantManager @User_EMAD
  Scenario Outline: TC-E2E-03-EMAD — Grant Manager finalizes transaction <txIndex>
    Given I navigate to the portal login page
